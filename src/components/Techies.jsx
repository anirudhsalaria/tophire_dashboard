...
const Techies = () => {
  return (
    <div className='w-full techiesimg  py-8 pb-14'>
      <div className='container py-8'>
        <div className=' text-center'>
          <div className='font-bold text-4xl '>Techies 💘 TopHire</div>
          <div className=' mt-6 text-lg text-jacarta-700'>A better love story than twilight. Check the video below to find out why.</div>
          <div className=' mt-14'>
        ...
        <div className='container  mt-16 grid md:grid-cols-3 sm:grid-rows-1 p-3 gap-9 px-12'>
          ...
          <div className=''>
            ...
            <div className=' mt-5 text-jacarta-600'>
